...
<input type="hidden" id="account" value="${patient[0].cardId}">
<form action="${pageContext.request.contextPath}/sellCardServlet?methodName=cancelCard" method="past">
<div class="Div">
    <form>
        <table width="100%">
            ...
            <tr  height=40px align="center">
                ...
                <td width="12.5%"  colspan="4">
                    <input  type="text" id="read" name="read" placeholder="请输入卡号" style="width: 100%;height: 80%" value="${read}">
                </td>
            ...
            <tr  height=40px align="center">
                <td width="12.5%" colspan="8" ><input type="button" value="退卡"  style="width: 10%;height: 100%" onclick="quitCard()"></td>
            </tr>
        </table>
    </form>
</div>
